...
import com.osi.democracy.domain.Address;
import com.osi.democracy.domain.enumeration.State;
import com.osi.democracy.repository.AddressRepository;
...
class AddressResourceIT {
    ...
    private static final String DEFAULT_ZIP = "AAAAAA";
    private static final String UPDATED_ZIP = "BBBBBB";
    ...
    void putExistingAddress() throws Exception {
        ...
        updatedAddress.line1(UPDATED_LINE_1).line2(UPDATED_LINE_2).city(UPDATED_CITY).state(UPDATED_STATE).zip(UPDATED_ZIP);
    ...
    void partialUpdateAddressWithPatch() throws Exception {
        ...
        partialUpdatedAddress.line2(UPDATED_LINE_2).city(UPDATED_CITY).state(UPDATED_STATE);
    ...
    void fullUpdateAddressWithPatch() throws Exception {
        ...
        partialUpdatedAddress.line1(UPDATED_LINE_1).line2(UPDATED_LINE_2).city(UPDATED_CITY).state(UPDATED_STATE).zip(UPDATED_ZIP);
