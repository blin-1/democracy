...
class PositionResourceIT {
    ...
    public static Position createEntity(EntityManager em) {
        Position position = new Position().available(DEFAULT_AVAILABLE);
        return position;
    }
    ...
    public static Position createUpdatedEntity(EntityManager em) {
        Position position = new Position().available(UPDATED_AVAILABLE);
        return position;
    }
    ...
    void createPosition() throws Exception {
        ...
        assertThat(testPosition.getAvailable()).isEqualTo(DEFAULT_AVAILABLE);
    }
    ...
    void putExistingPosition() throws Exception {
        ...
        updatedPosition.available(UPDATED_AVAILABLE);
        ...
        Position testPosition = positionList.get(positionList.size() - 1);
        assertThat(testPosition.getAvailable()).isEqualTo(UPDATED_AVAILABLE);
    }
    ...
    void fullUpdatePositionWithPatch() throws Exception {
        ...
        partialUpdatedPosition.available(UPDATED_AVAILABLE);
