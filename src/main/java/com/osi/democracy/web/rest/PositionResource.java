...
import com.osi.democracy.service.PositionService;
...
public class PositionResource {
    ...
    public ResponseEntity<List<PositionDTO>> getAllPositions(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
