package com.osi.democracy.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.osi.democracy.service.EmailAlreadyUsedException ||
            ex instanceof com.osi.democracy.service.UsernameAlreadyUsedException
        ) {
        ...
        if (ex instanceof com.osi.democracy.service.InvalidPasswordException) return (ProblemDetailWithCause) new InvalidPasswordException()
            .getBody();
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "com.osi.democracy");
    }
}
