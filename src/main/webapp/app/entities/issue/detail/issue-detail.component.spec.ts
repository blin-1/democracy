...
describe('Issue Management Detail Component', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [IssueDetailComponent, RouterTestingModule.withRoutes([], { bindToComponentInputs: true })],
      providers: [
        provideRouter(
          [
            {
  ...
  describe('OnInit', () => {
    it('Should load issue on init', async () => {
      ...
      // THEN
      expect(instance.issue).toEqual(expect.objectContaining({ id: 123 }));
    });
  });
